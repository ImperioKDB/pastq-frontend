          ...
          <div style={{ background:'#fff', borderRadius:'20px', padding:'40px', border:'1px solid #e2e8f0' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
              <div>
                ...
                <input value={year} onChange={e => setYear(e.target.value)} placeholder="e.g. 2023" style={{ width:'100%', padding:'12px 14px', border:'1px solid #e2e8f0', borderRadius:'10px', fontSize:'14px' }} />
              </div>
              <div>
                <label style={{ fontSize:'13px', fontWeight:600, color:'#374151', display:'block', marginBottom:'8px' }}>Number of Questions</label>
                <select value={count} onChange={e => setCount(e.target.value)} style={{ width:'100%', padding:'12px 14px', border:'1px solid #e2e8f0', borderRadius:'10px', fontSize:'14px', background:'#fff' }}>
            ...
            {answers.map((a, i) => {
              ...
              return (
                <div key={i} style={{ background:'#fff', borderRadius:'12px', padding:'16px 20px', border:`1px solid ${correct ? '#86efac' : '#fca5a5'}` }}>
                  ...
                  <p style={{ margin:'0 0 8px', fontSize:'14px', color:'#0f172a' }}>{a.q.content}</p>
                  {!correct && (
                    <div style={{ fontSize:'13px', color:'#6b7280' }}>
                      Your answer: <span style={{ color:'#dc2626', fontWeight:600 }}>{a.selected || 'None'}</span>
                      {' · '}Correct: <span style={{ color:'#16a34a', fontWeight:600 }}>{a.q.answer}</span>
                    </div>
                  )}
                </div>
              );
    ...
    <main style={{ minHeight:'100vh', background:'#f8fafc', padding:'40px 24px' }}>
      <div style={{ maxWidth:'600px', margin:'0 auto' }}>
        ...
        <div style={{ background:'#fff', borderRadius:'20px', padding:'32px', border:'1px solid #e2e8f0', marginBottom:'20px' }}>
          ...
          <p style={{ fontFamily:"'Sora',sans-serif", fontSize:'18px', fontWeight:600, color:'#0f172a', lineHeight:1.6, margin:'0 0 28px' }}>{q.content}</p>
